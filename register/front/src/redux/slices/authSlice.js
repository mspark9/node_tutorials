...
export const fetchPostRegisterData = postRegisterFetchThunk('fetchPostRegisterData', POST_AUTH_URL)
export const fetchPostLoginData = postLoginFetchThunk('fetchPostLoginData', POST_LOGIN_URL)
