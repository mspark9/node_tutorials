            ...
            <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                {user ? (
                    <div className="relative">
                        <button className="flex items-center gap-3 rounded-full cursor-default"
                    ...
                    <Link to="/login" className='text-sm font-medium px-4 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition'>
                        Login
                    </Link>
                )}
            </div>
